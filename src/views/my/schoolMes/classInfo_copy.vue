<template>
  <div class="container">
    ...
    <div class="tip">为了匹配阅读等级，请完善你的信息！</div>
    <div class="list">
      <div class="item" @click="showPicker = true">
        <span>年级</span>
        <span>请选择<img src="../../../assets/new/32.png" /></span>
      </div>
      <div class="item" @click="showPicker = true">
        <span>班级</span>
        <span>请选择<img src="../../../assets/new/32.png" /></span>
...
.container {
  ...
  button {
    background-color: rgba(53, 185, 255, 0.63);
    border-radius: 40px;
    width: 12.05rem;
    height: 2.2rem;
  ...
  .tip {
    background-color: rgba(53, 185, 255, 0.09);
    height: 1.85rem;
    width: 100%;
    color: rgba(53, 185, 255, 1);
    font-size: 0.625rem;
    font-family: PingFangSC-Light;
    display: flex;
    align-items: center;
